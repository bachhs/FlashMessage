...
export default function UserProfileView(route) {
    ...
    function handleButtonPress() {
        let docRef = firestore().collection('users').doc(route.route.params.user._id);
        docRef.update({
            name: name,
            email: email,
            location: location,
            ...
            <View style={styles.body}>
                ...
                <View style={styles.item}>
                    <View style={styles.iconContent}>
                        <Image style={styles.icon} source={{ uri: 'https://img.icons8.com/ios/452/name.png' }} />
                    </View>
                ...
                <FormButton
                    ...
                    disabled={email == '' || name == '' || location == '' || phoneNumber == ''}
